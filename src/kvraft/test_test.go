...
func TestOnePartition3A(t *testing.T) {
	...
	ckp1 := cfg.makeClient(-1, p1)  // connect ckp1 to p1
	ckp2a := cfg.makeClient(-1, p2) // connect ckp2a to p2
	ckp2b := cfg.makeClient(-1, p2) // connect ckp2b to p2
